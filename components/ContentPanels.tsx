                        ...
                        <tbody>
                            {companies.map(company => (
                                <tr key={company.id} className={`border-b border-gray-700 hover:bg-gray-700/30 transition-colors ${company.blocked ? 'bg-red-900/40 opacity-80' : ''}`}>
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-1 text-xs font-medium rounded-full flex items-center gap-1.5 w-fit ${
                                            company.blocked
        ...
        dayElements.push(
            <div key={day} className="relative flex justify-center items-center">
                <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors text-sm font-medium ${
                        isSelected 
